  ...
  protected KeyBlockResult map(KeyBlock generatedResultObject) {
    if (generatedResultObject != null)
      return this.toBuilder()
          ...
          .prevHash(generatedResultObject.getPrevHash())
          .prevKeyHash(generatedResultObject.getPrevKeyHash())
          .stateHash(generatedResultObject.getStateHash())
          .miner(generatedResultObject.getMiner())
          .beneficiary(generatedResultObject.getBeneficiary())
          .target(generatedResultObject.getTarget())
          .pow(generatedResultObject.getPow())
          .nonce(generatedResultObject.getNonce())
          .time(generatedResultObject.getTime())
          .version(generatedResultObject.getVersion())
          .info(generatedResultObject.getInfo())
          .build();

...
public class AccountResult extends GenericResultObject<Account, AccountResult> {
	...
	protected AccountResult map(Account generatedResultObject) {
		if (generatedResultObject != null)
			return this.toBuilder().publicKey(generatedResultObject.getId()).balance(generatedResultObject.getBalance())
					.nonce(generatedResultObject.getNonce()).kind(generatedResultObject.getKind().toString())

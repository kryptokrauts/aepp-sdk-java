...
public class PayingForTransaction
  ...
  public Bytes createRLPEncodedList() {
    Bytes encodedRlp = RLP.encodeList(rlpWriter -> {
      ...
      byte[] payerIdWithTag = EncodingUtils.decodeCheckAndTag(model.getPayerId(),
      ...
      rlpWriter.writeByteArray(EncodingUtils.decodeCheckWithIdentifier(model.getInnerTxHash()));
    });
    return encodedRlp;
  }

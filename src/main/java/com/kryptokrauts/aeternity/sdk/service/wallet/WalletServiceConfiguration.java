...
public class WalletServiceConfiguration extends ServiceConfiguration {
    ...
    @Default
    private String symmetricAlgorithm = "xsalsa20-poly1305";

    @Default
    private int memlimitKIB = 65536;
    ...
    @Default
    private String argon2Mode = "argon2id";

    @Default
    private Argon2Types argon2Type = Argon2Types.ARGON2id;
}

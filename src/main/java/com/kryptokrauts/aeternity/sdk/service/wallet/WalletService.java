...
public interface WalletService {
	...
	/**
	 * generate a JSON keystore which can be stored in a file for later recovery of
	 * the private key
	 * 
	 ...
	 * @return encrypts the keypair using the given walletPassword an returns a JSON

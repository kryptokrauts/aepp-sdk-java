...
public final class SophiaCompilerServiceImpl implements CompilerService {
	...
	public Single<String> asyncEncodeCalldata(String sourceCode, String function, List<String> arguments) {
		return this.compilerApi.rxEncodeCalldata(buildFunctionCallInput(sourceCode, function, arguments))
	...
	public String blockingEncodeCalldata(String sourceCode, String function, List<String> arguments) {
		return this.compilerApi.rxEncodeCalldata(buildFunctionCallInput(sourceCode, function, arguments)).blockingGet()
				.getCalldata();
	}
	...
	public Object blockingDecodeCalldata(String calldata, String sophiaType) {
		return Optional.ofNullable(this.compilerApi.rxDecodeData(buildDecodeBody(calldata, sophiaType)).blockingGet())
	...
	@Override
	public Single<ACIResult> asyncGenerateACI(String contractCode, String srcFile, Object fileSystem) {
		return ACIResult.builder().build()
	...
	public ACIResult blockingGenerateACI(String contractCode, String srcFile, Object fileSystem) {
		return ACIResult.builder().build()
				.blockingGet(this.compilerApi.rxGenerateACI(buildACIBody(contractCode, srcFile, fileSystem)));
	}
	...
	public Single<String> asyncCompile(String contractCode, String srcFile, Object fileSystem) {
		return this.compilerApi.rxCompileContract(buildContractBody(contractCode, srcFile, fileSystem))
				.map(byteCode -> byteCode.getBytecode());
	}

	@Override
	public String blockingCompile(String contractCode, String srcFile, Object fileSystem) {
		return this.compilerApi.rxCompileContract(buildContractBody(contractCode, srcFile, fileSystem)).blockingGet()
				.getBytecode();
	}

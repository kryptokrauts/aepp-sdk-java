...
public final class SophiaCompilerServiceImpl implements CompilerService {
	...
	public Single<ACIResult> asyncGenerateACI(String contractCode, String srcFile, Object fileSystem) {
		return ACIResult.builder().build()
				.asyncGet(this.getCompilerApi().rxGenerateACI(buildACIBody(contractCode, srcFile, fileSystem)));
	}

	@Override
	public ACIResult blockingGenerateACI(String contractCode, String srcFile, Object fileSystem) {
		return ACIResult.builder().build()
				.blockingGet(this.getCompilerApi().rxGenerateACI(buildACIBody(contractCode, srcFile, fileSystem)));
	}

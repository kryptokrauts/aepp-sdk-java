...
public final class AccountServiceImpl implements AccountService {
  ...
  public Single<AccountResult> asyncGetAccount() {
    return AccountResult.builder()
        .build()
        .asyncGet(externalApi.rxGetAccountByPubkey(config.getBaseAccount().getAddress()));
  }
  ...
  public Single<AccountResult> asyncGetAccount(final String base58PublicKey) {
    return AccountResult.builder()
        .build()
        .asyncGet(externalApi.rxGetAccountByPubkey(base58PublicKey));
  }
  ...
  public AccountResult blockingGetAccount() {
    return AccountResult.builder()
        .build()
        .blockingGet(externalApi.rxGetAccountByPubkey(config.getBaseAccount().getAddress()));
  }
  ...
  public AccountResult blockingGetAccount(final String base58PublicKey) {
    return AccountResult.builder()
        .build()
        .blockingGet(externalApi.rxGetAccountByPubkey(base58PublicKey));
  }

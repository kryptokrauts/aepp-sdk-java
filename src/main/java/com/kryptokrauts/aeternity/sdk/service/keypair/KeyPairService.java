...
public interface KeyPairService {
	...
	/**
	 * encrypts the public and private key of the given rawKeyPair using the given
	 * password
	 * 
	 * @param keyPairRaw
	 * @param password
	...
	/**
	 * creates a keyPair as well as a list of mnemonic seed words which can be used
	 * to restore the key (derived from BIP32/39 HD-Wallet generation) the number of
	 * seed words depends on the parameter defined in
	 * {@link KeyPairServiceConfiguration}
	 * 
	 * @param mnemonicSeedPassword password or null which is used to seed the list
	 *                             of mnemonics
	 * @return keypair with private and public key as well as the generated list of
	 *         mnemonic seed words
	 ...
	 * @throws AException
	 */
	MnemonicKeyPair recoverMnemonicKeyPair(List<String> mnemonicSeedWords, String mnemonicSeedPassword)
			throws AException;
}

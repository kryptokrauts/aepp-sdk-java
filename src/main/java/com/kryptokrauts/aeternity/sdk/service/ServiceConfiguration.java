...
public class ServiceConfiguration {
	...
	@Default
	@Nonnull
	protected String aeternalBaseUrl = BaseConstants.DEFAULT_TESTNET_AETERNAL_URL;
	...
	public ApiClient getApiClient() {
		if (vertx == null) {
			_logger.debug(
					"Vertx entry point not initialized, creating default");
			vertx = Vertx.vertx();
		}
		if (vertx != null && baseUrl != null) {
			_logger.debug(String.format(
					"Initializing Vertx ApiClient using baseUrl %s", baseUrl));
			return new ApiClient(vertx,
					new JsonObject(new HashMap<String, Object>(ImmutableMap
							.of(BaseConstants.VERTX_BASE_PATH, baseUrl))));
		} else
	...
	public com.kryptokrauts.sophia.compiler.generated.ApiClient getCompilerApiClient() {
		...
		if (vertx != null && compilerBaseUrl != null) {
			_logger.debug(String.format(
					"Initializing Vertx CompilerApiClient using compilerBaseUrl %s",
					compilerBaseUrl));
			return new com.kryptokrauts.sophia.compiler.generated.ApiClient(
					vertx,
					new JsonObject(new HashMap<String, Object>(ImmutableMap.of(
							BaseConstants.VERTX_BASE_PATH, compilerBaseUrl))));
		} else
			throw new RuntimeException(
	...
	public com.kryptokrauts.aeternal.generated.ApiClient getAeternalApiClient() {
		...
		if (vertx != null && aeternalBaseUrl != null) {
			_logger.debug(String.format(
					"Initializing Vertx AeternalApiClient using aeternalBaseUrl %s",
					aeternalBaseUrl));
			return new com.kryptokrauts.aeternal.generated.ApiClient(vertx,
					new JsonObject(new HashMap<String, Object>(ImmutableMap.of(
							BaseConstants.VERTX_BASE_PATH, aeternalBaseUrl))));
		} else
			throw new RuntimeException(

...
public class EventModel extends GenericResultObject<Event, EventModel> {
	...
	@Default
	private List<BigInteger> topics = new ArrayList<>();
	...
	protected EventModel map(Event generatedResultObject) {
		if (generatedResultObject != null)
			return this.toBuilder().address(generatedResultObject.getAddress()).data(generatedResultObject.getData())
					.topics(generatedResultObject.getTopics()).build();
		else

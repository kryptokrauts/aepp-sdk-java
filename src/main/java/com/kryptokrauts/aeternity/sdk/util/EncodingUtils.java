...
public final class EncodingUtils {
	...
	public static final String addressToHex(final String base58CheckAddress) {
		return PREFIX_ZERO_X
				+ Hex.toHexString(decodeBase58Check(assertedType(base58CheckAddress, ApiIdentifiers.ACCOUNT_PUBKEY)));
	}
	...
	public static String generateCommitmentHash(final String name, final BigInteger salt) {
		return encodeCheck(hash(ByteUtils.concatenate(nameId(name), formatSalt(salt))), ApiIdentifiers.COMMITMENT);
	}

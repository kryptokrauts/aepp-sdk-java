...
public final class EncodingUtils {
    ...
    public static final String encodeCheck( final byte[] input, String identifier ) throws IllegalArgumentException, EncodingNotSupportedException {
        ...
        throw new EncodingNotSupportedException( String.format( "Cannot determine encoding type from given identifier %s", identifier ) );
    }
    ...
    public static final String encodeCheck( final byte[] input, EncodingType encodingType ) throws EncodingNotSupportedException {
        switch ( encodingType ) {
            ...
            default :
                throw new EncodingNotSupportedException( String.format( "Encoding %s is currently not supported", encodingType ) );
        }
    }

    /**
     * decode input which is combined of the identifier and the encoded string
     * (e.g. ak_[encoded])
     *
     * @param input
     * @return

...
public interface ApiIdentifiers {
    ...
    String[] IDENTIFIERS_B58 = {ACCOUNT_PUBKEY, BLOCK_PROOF_OF_FRAUD_HASH, BLOCK_STATE_HASH, BLOCK_TRANSACTION_HASH, CHANNEL, COMMITMENT, CONTRACT_PUBKEY,
                                KEY_BLOCK_HASH, MICRO_BLOCK_HASH, NAME, ORACLE_PUBKEY, ORACLE_QUERY_ID, PEER_PUBKEY, SIGNATURE, TRANSACTION_HASH };
    ...
    {CONTRACT_BYTE_ARRAY, ORACLE_RESPONSE, ORACLE_QUERY, PROOF_OF_INCLUSION, STATE_TREES, STATE, TRANSACTION };
